...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${years} ${yearText}, ${months} ${monthText} y ${days} ${dayText}, desde que nos conocemos, y este san valentin es muy distinto a los otros. Me alegra mucho seguir compartiendo con vos y disfrutar de cada momento a nuestra manera, el proximo espero estar a tu lado. Te quiero mucho muchooo mi amor❤️!`;
  }
});
